...
@EnableJpaRepositories(
        basePackages = "com.example.sync.repository.source",
...
public class SourceJpaConfig {
    ...
    public SourceJpaConfig(JpaProperties jpaProperties, HibernateProperties hibernateProperties) {
    ...
    public LocalContainerEntityManagerFactoryBean sourceEntityManager(
        ...
        return builder
                ...
                .packages("com.example.sync.domain.source")
    ...
    public PlatformTransactionManager sourceTransactionManager(
            @Qualifier("sourceEntityManager") LocalContainerEntityManagerFactoryBean entityManagerFactory) {
